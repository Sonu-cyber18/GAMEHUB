...
def hill_climber_view(request):
    """Render the physics-based hill climber game."""
    context = {
        "high_scores": _get_neon_rush_high_scores(),
    }
    return render(request, 'hill_climber.html', context)
...
def ludo_game_view(request):
    return render(request, 'ludo_game.html')
...
def stickman_hitman_view(request):
    return render(request, 'stickman_hitman.html')
def endless_runner_view(request):
    return render(request, 'endless_runner.html')

def itf_view(request):
    return render(request, 'itf.html')
